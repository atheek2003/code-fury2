...
const Cards = ({ title, desc, link, date, time, type }) => {
  return (
    <div>
      <div className="w-64 p-6 bg-white border flex flex-col justify-center items-center border-gray-200 rounded-lg shadow-xl h-52">
